		...
		<header id="header">
			<div class="header-box">
				...
				<ul class="header-right">
					<li class="denglu" id="denglu"><a href="denglu.html">您好，请登录</a> <a href="zhuce.html"  class="red">免费注册</a></li> 
					<li class="shu"></li>
					...
					<li class="my bj">
						...
						<div class="my1">
							<div class="my2">
								...
								<div class="my3">
									<h3 class="neirong2"><a href="" id="yhm">您好请登录</a></h3>
			...
			<div class="dd-inner">
				...
				<div class="fore-2">
					<div class="item fore2">
						<h3>
							<a href="/xmu/taobao/home/search.jsp">手机、</a><a href="">数码、</a><a href="">京东通讯</a>
						</h3>
						<i>></i>
					</div>
					<div class="font-item1">
