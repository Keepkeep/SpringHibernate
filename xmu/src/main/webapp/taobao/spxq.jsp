...
<script type="text/javascript" src="js/list.js"></script>
	...
	<script type="text/javascript">
		//<ul><li  class="sku-line selected">黑色<i></i></li>
		$(function(){
			alert($("ul li class='sku-line selected'"));
			//alert("123");
		});
		//加载页面
		$(function(){
			$.post("/xmu/product/dangelist.sw",{proId:GetQueryString("proId")},function(data){
				$("#spname").html(data.decript);	
				$("#cxj").html(data.salePrice);
				$("#yj").html(data.price);
				 $("#fdj").attr('src',data.image).attr('rel',data.image);
				$("#afdj").attr('href',data.image);  
			});
		});
		//获取单个url路径的参数
		...
		<div class="scoll">
			<section class="slider">
				<div class="flexslider">
					<ul class="slides">
						<li><img src="images/shou" title="pic" /></li>
						<li><img src="" /></li>
			...
			<div class="clearfixLeft" id="clearcontent">
				...
				<div class="box">
					...
					<div class="tb-booth tb-pic tb-s310">
						<a id="afdj" href="../images/01.jpg"><img src="images/shouji/sanxings8.jpg"
							id="fdj" alt="细节展示放大镜特效" rel="images/shouji/sanxings8.jpg" class="jqzoom" /></a>
					</div>
					<ul class="tb-thumb" id="thumblist">
						<li class="tb-selected">
							<div class="tb-pic tb-s40">
								<a href="#"><img src="images/shouji/sanxings8.jpg"
									mid="images/shouji/sanxings8.jpg" big="images/shouji/sanxings8.jpg"></a>
							</div>
						</li>
						<li>
							<div class="tb-pic tb-s40">
								<a href="#"><img src="images/shouji/sanxings82.jpg"
									mid="images/shouji/sanxings82.jpg" big="images/shouji/sanxings82.jpg"></a>
							</div>
						</li>
						<li>
							<div class="tb-pic tb-s40">
				...
				<div class="tb-detail-list">
					...
					<div class="tb-detail-price">
						<li class="price iteminfo_price">
							<dt>促销价</dt>
							<dd>
								<em>¥</em><b id="cxj" class="sys_item_price">56.90</b>
							</dd>
						</li>
						<li class="price iteminfo_mktprice">
							<dt>原价</dt>
							<dd>
								<em>¥</em><b id="yj" class="sys_item_mktprice">98.00</b>
							</dd>
						</li>
						<div class="clear"></div>
					</div>
						...
						<dd>
							...
							<div class="theme-popover">
								...
								<div class="theme-popbod dform">
									<form class="theme-signin" id="form1" name="loginform" action="test.sw"
										method="post">
										<input type="hidden" id="name" name="SPName">
										<input type="hidden" id="jg" name="CXJ">
										<input type="hidden" id="lb" name="leibie">
										<div class="theme-signin-left">

											<div class="theme-options">
												<div class="cart-title">颜色</div>
												<ul>
													<li  class="sku-line selected">黑色<i></i></li>
													<li  class="sku-line"> 灰色 <i></i></li>
													<li  class="sku-line"> 银色<i></i></li>
													<li  class="sku-line"> 中国红<i></i></li>
												</ul>
											</div>
											<div class="theme-options">
												<div class="cart-title">内存类型</div>
												<ul>
													<li class="sku-line selected"> 64G <i></i></li>
													<li class="sku-line"> 128G <i></i></li>
													<li class="sku-line"> 256G <i></i></li>
												</ul>
											</div>
											<div class="theme-options">
												...
												<dd>
													<input id="min" class="am-btn am-btn-default" name=""
														type="button" value="-" /> <input id="text_box" name="SL"
				...
				<div class="pay">
					...
					<li>
						<div class="clearfix tb-btn tb-btn-buy theme-login">
							<a id="LikBuy" title="点此按钮到下一步确认购买信息" onclick="submit1()" href="javascript:;">立即购买</a>
						</div>
					</li>
					<li>
...
var leibie = $("li[class='sku-line selected']").text();
	console.log(leibie);
var sl = $("#text_box").val();
var spname = $("#spname").text();
var cxj = $("#cxj").text();
//	$.post("test.sw",{SPName:spname,CXJ:cxj,LB:leibie,SL:sl});
$("#name").val(spname);
$("#jg").val(cxj);
$("#lb").val(leibie);
$("#form1").submit();
